...
$CONFIG = '{"lang":"zh","error_reporting":false,"show_hidden":false,"hide_Cols":false,"theme":"dark"}';
...
$auth_users = array(
    'admin' => '$2y$10$sVCe9g2E7bzXc.2Fdz0YpuYgurIAvZC0Pl2dtDBaAXrQ7vT8plSeq', //admin@123
...
$default_timezone = 'Asia/Shanghai'; // 北京时间
...
$favicon_path = 'https://lkz.pub/images/lkz.jpg';
...
$max_upload_size_bytes = 50000000000; // size 5,000,000,000 bytes (~5GB)
...
$external = array(
    'css-bootstrap' => '<link href="https://pan.lkz.pub/lkz/webcdn/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">',
    'css-dropzone' => '<link href="https://pan.lkz.pub/lkz/webcdn/css/dropzone.min.css" rel="stylesheet">',
    'css-font-awesome' => '<link rel="stylesheet" href="https://pan.lkz.pub/lkz/webcdn/css/font-awesome.min.css" crossorigin="anonymous">',
    ...
    'js-ace' => '<script src="https://pan.lkz.pub/lkz/webcdn/js/ace.js"></script>',
    'js-bootstrap' => '<script src="https://pan.lkz.pub/lkz/webcdn/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>',
    'js-dropzone' => '<script src="https://pan.lkz.pub/lkz/webcdn/js/dropzone.min.js"></script>',
    'js-jquery' => '<script src="https://pan.lkz.pub/lkz/webcdn/js/jquery-3.6.1.min.js" integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ=" crossorigin="anonymous"></script>',
    'js-jquery-datatables' => '<script src="https://pan.lkz.pub/lkz/webcdn/js/jquery.dataTables.min.js" crossorigin="anonymous" defer></script>',
    'js-highlightjs' => '<script src="https://pan.lkz.pub/lkz/webcdn/js/highlight.min.js"></script>',
                ...
                <div class="row justify-content-md-center align-content-center h-100vh">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://beian.miit.gov.cn/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">皖ICP备17027815号-7</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://lkz.pub" target="_blank" class="float-right text-muted">刘刻舟的网盘 <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://lkz.pub" target="_blank" class="float-right text-muted">刘刻舟的网盘 <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
?>
    <!DOCTYPE html>
    <html lang="zh" data-bs-theme="<?php echo (FM_THEME == "dark") ? 'dark' : 'light' ?>">
